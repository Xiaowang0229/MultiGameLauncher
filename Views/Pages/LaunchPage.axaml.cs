...
public partial class LaunchPage : UserControl
{
    ...
    public async void Page_Loaded(object sender,RoutedEventArgs e)
    {
        ...
        PlayedTime.Text = $"游戏时长:{gi.GamePlayedMinutes}分钟";
        ...
        if(!File.Exists(gi.Launchpath))
        {
            LaunchTile.IsEnabled = false;
            Variables._MainWindow.ShowInfoBar("提示","游戏文件不存在,请到设置更改!");
        }
    ...
    public void ChangePlayedTime(string Time)
    {
        PlayedTime.Text = $"游戏时长:{Time}分钟";
    }
